...
class SyGuS_v1Visitor(ParseTreeVisitor):
    ...
    def visitInput_variable_g_term(
        self, ctx: SyGuS_v1Parser.Input_variable_g_termContext
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SyGuS_v1Parser#local_variable_g_term.
    def visitLocal_variable_g_term(
        self, ctx: SyGuS_v1Parser.Local_variable_g_termContext
    ):
        return self.visitChildren(ctx)
